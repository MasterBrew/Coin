...
echo ''
echo '****************************************************************************'
echo '*                        Installing Ravencoin Wallet!                        *'
echo '****************************************************************************'
echo ''
...
echo ''
echo '****************************************************************************'
echo '*       Creating Directory ~/wallets to install Ravencoin source code.       *'
echo '****************************************************************************'
...
var4=`date`
echo "Start fase 5 : $var3 - Cloning into Git to get Ravencoin." >> fase5.log

git clone https://github.com/RavenProject/Ravencoin.git

cd Ravencoin

#read -n 1 -s -r -p "           * Press key to start frontend parsing Ravencoin  *"
echo ''
echo ''
echo '****************************************************************************'
